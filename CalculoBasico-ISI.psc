Algoritmo CalculoBasico
	Definir NumX, NumY, Suma, Dif, Producto, Cociente, Potencia Como Entero 
	...
	Escribir "El producto de: " Numx " * " Numy " es: " Prodcuto
	Escribir "El cociente de: " Numx " / " Numy " es: " Cociente
	Escribir "El resultado de de la potencia de: " Numx " elevado a " Numy " es: " Potencia
